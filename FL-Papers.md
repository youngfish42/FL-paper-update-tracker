...
- Does One-shot Give the Best Shot? Mitigating Model Inconsistency in One-shot Federated Learning. [[PUB](https://openreview.net/forum?id=2XvF67vbCK)]
...
- Federated Disentangled Tuning with Textual Prior Decoupling and Visual Dynamic Adaptation. [[PUB](https://openreview.net/forum?id=0p86Mhg014)]
...
- GHOST: Generalizable One-Shot Federated Graph Learning with Proxy-Based Topology Knowledge Retention. [[PUB](https://openreview.net/forum?id=nAk0ENu8LS)]
...
- One Arrow, Two Hawks: Sharpness-aware Minimization for Federated Learning via Global Model Trajectory. [[PUB](https://openreview.net/forum?id=80mK2Mqaph)]
...
- SPMC: Self-Purifying Federated Backdoor Defense via Margin Contribution. [[PUB](https://openreview.net/forum?id=Kjz03pmyW0)]
...
- Enhancing Storage and Computational Efficiency in Federated Multimodal Learning for Large-Scale Models. [[PUB](https://openreview.net/forum?id=QgvBcOsF4B)]
...
- Better Generative Replay for Continual Federated Learning. [[PUB](https://openreview.net/pdf?id=cRxYWKiTan)]
...
- FedFA: Federated Feature Augmentation. [[PUB](https://openreview.net/pdf?id=U9yFP90jU0)]
...
- Instance-wise Batch Label Restoration via Gradients in Federated Learning. [[PUB](https://openreview.net/pdf?id=FIrQfNSOoTr)]
- Machine Unlearning of Federated Clusters. [[PUB](https://openreview.net/pdf?id=VzwfoFyYDga)]
...
- PerFedMask: Personalized Federated Learning with Optimized Masking Vectors. [[PUB](https://openreview.net/pdf?id=hxEIgUXLFF)]
...
- Test-Time Robust Personalization for Federated Learning. [[PUB](https://openreview.net/pdf?id=3aBuJEza5sq)]
